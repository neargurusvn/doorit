...
<section>
	...
	<div class="row">
        ...
        <div class="row">    
            <div class="col-md-12 bg-color"> 
               <div class="container">
                   <h3 class=""> <a href="#" title=""></a><b> List of users </b></h3>
               </div>
           </div>
		</div>
			<div class="row" style="padding-top:30px;margin-bottom:3%;background:#1D4E64;color:white">
		 ...
		 <c:forEach var="reportObj" items="${reportList}">
				<div class="row">
						...
						<div class="col-md-4">          
							<b>${reportObj.user.emailId}
							<br/>
							<c:if test="${reportObj.user.enabled eq false }">  
								<a  href="${pageContext.request.contextPath}/toggleEmailSend/${reportObj.user.userId}/true"  style="width:80%" class="btn btn-success">Enable email</a>
							</c:if> <br/>
							<c:if test="${reportObj.user.enabled eq true }">   
								<a  href="${pageContext.request.contextPath}/toggleEmailSend/${reportObj.user.userId}/false"  style="width:80%" class="btn btn-success">Disable email</a>
							</c:if>
