...
<section class="bg-color"> 
 <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 ">
               <div class="container">
                   <h2 class=""> <a href="${pageContext.request.contextPath}/manageRequest" title=""><i class="fa fa-arrow-circle-o-left"></i></a> Select vendor for ${productName.product_name} request </h2>
               </div>
           </div>
...
<div class="container">
    ...
    <section id="section-welcome"  class="section ">
		...
		<c:if test="${wrapRequestServiceWrapper.requestService.status eq 'WIP'}">  
					<div class="text-center alert alert-success" >    			
   						<label style="padding-top:20px;padding-bottom:15px"><b> Project awarded to ${wrapRequestServiceWrapper.prosProfile.companyName} </b></label>
   					</div>  
          ...
          <div class="tab-content" style="margin-top:20px;"> 
                  ...
                  <div class="row">
        			 ...
        			 <div class="text-center bg-info text-info" style="height:60px;">       
   						<h4 style="padding-top:20px;padding-bottom:15px">You  have not recieved any  active Quotes yet.</h4>   
  					 </div> 
                  ...
                  <img src="<c:url value="/resources/assets/img/imgPlace.jpg" />" class="img-responsive img-circle" alt="avatar" >
                                ...
                                <div class="col-xs-6 col-sm-2 col-md-3" style=" border-right: 1px dotted #ccc"> 
                                    ...
                                    <div class="col-xs-12 col-sm-7 col-md-6 excerpet">
                                        ...
                                        <p style="word-wrap:break-word;word-break:break-all;">${quotesRecived.quote.message}</p> 
                                    ...
                                    <div class="col-xs-12 col-sm-2 col-md-2 text-center">
										...
										<c:choose>
    										<c:when test="${quotesRecived.quote.status eq 'WIP'}">
   												<button type="submit" disabled   class="btn btn-success"><span class="fa fa-ticket"></span>&nbsp;HIRE </button>
   										 			    										</c:when>
   											<c:when test="${quotesRecived.requestService.status eq 'OLD'} ">
   											 ...
   											 <c:when test="${quotesRecived.quote.status eq 'IP' and quotesRecived.requestService.status ne 'OLD' }">
   													  <button type="submit"   class="btn btn-success"><span class="fa fa-ticket"></span>&nbsp;HIRE</button>
