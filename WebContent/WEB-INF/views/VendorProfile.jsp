     ...
     <!-- HEADER SECTION -->
        ...
        <div class="row" style="margin-bottom:30px">
            <div class="col-md-12 bg-color">
               <div class="container">
                   <h2 class="">  <a href="${pageContext.request.contextPath}/quotesDescription/${serviceRequestId}" title=""><i class="fa fa-arrow-circle-o-left"></i></a>   ${vendorProfile.companyName} profile </h2>
               </div>
           </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-2">
                   		 <c:choose>
              			   <c:when test="${vendorProfile.user.filename ne null}">
                 				 <img src="<c:url value="/download/${vendorProfile.user.userId}" />" class="img-responsive img-circle" alt="avatar" >
              			   </c:when>
              			   <c:otherwise>
                                ...
                                <tbody>
                                   <tr>
                                    ...
                                    <tr>
                                      ...
                                      <c:if test="${not empty  vendorProfile.yearOfEstablishment}">
                                    <tr>
                    ...
                    <div class="row ">
                        <div >
                           ...
                           <c:choose> 
                            ...
                            ${feedbackNumber} Reviews &nbsp;&nbsp; <button style="margin-top:20px;margin-bottom:20px;"  onclick="location.href = '${pageContext.request.contextPath}/writeFeedback/${proId}/${serviceRequestId}';" class="btn   btn-danger">Leave Feedback</button>
