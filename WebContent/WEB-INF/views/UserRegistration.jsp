...
<head>
    ...
    <title>Create your account-NearGuru</title>
...
<section>
		...
		<center>${wrapSuccessError.action}</center>
                    ...
                    <div class="panel-body">
						<c:url var="addUser" value="/createUser" ></c:url>
                            ...
                            <br>
                              ...
                              <div class="form-group">
                               ...
                               <p> By clicking Create Account, you indicate that you have read and agree to the <a style="cursor:pointer" onclick="openFooterLinks('termsOfUsage')">Terms of Use </a>and <a style="cursor:pointer" onclick="openFooterLinks('privacyPolicy')">Privacy Policy</a>.</p>  
